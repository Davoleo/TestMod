...
import com.davoleo.testmod.item.armor.ItemArmor;
...
public class ModItems {
    ...
    public static ItemArmor copperHelmet = new ItemArmor(EntityEquipmentSlot.HEAD, "copper_helmet");
    public static ItemArmor copperChestplate = new ItemArmor(EntityEquipmentSlot.CHEST, "copper_chestplate");
    public static ItemArmor copperLeggings = new ItemArmor(EntityEquipmentSlot.LEGS, "copper_leggings");
    public static ItemArmor copperBoots = new ItemArmor(EntityEquipmentSlot.FEET, "copper_boots");
